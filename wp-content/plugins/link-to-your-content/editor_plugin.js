...
(function() {
	...
	tinymce.PluginManager.requireLangPack('LinkToYourContent');
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceLinkToYourContent', function() {				
				ed.windowManager.open({
					...
					width : 560 + ed.getLang('LinkToYourContent.delta_width', 0),
					height : 460 + ed.getLang('LinkToYourContent.delta_height', 0),
					inline : 1
				}, {
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('LinkToYourContent', n.nodeName == 'IMG');
			});
		},
